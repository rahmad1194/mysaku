...
<body>
	<div class="container">
		<div class="row">
			<div class="banner">
				<img src="background/banner-1.png" alt="">
			</div>
		</div>
		<br>
		<div class="row">
			...
			<div class="col-12 text-heading">
				<center>Daftar sekarang,<br>Nikmati mudahnya bertransaksi</center>
			<br>
			</div>
			<!-- <div class="col-1"></div> -->
		</div>
		<div class="row">
			<div class="col-1"></div>
			<button class="btn btn-white col-10"><a href="utama2.php">Next</a></button>
			<div class="col-1"></div>
		</div>
		<div class="row">
			<div class="bottom">
