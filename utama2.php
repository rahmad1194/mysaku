...
<body>
	<div class="container">
		<div class="row">
			<div class="banner">
				<img src="background/banner-2.png" alt="">
			</div>
		</div>
		<br>
		<div class="row">
			...
			<div class="col-12 text-heading">
				<center>Satu Transaksi,<br>untuk semua pembayaran</center>
			<br>
			</div>
			<!-- <div class="col-1"></div> -->
		</div>
		<div class="row">
			<div class="col-1"></div>
			<button class="btn btn-white col-10"><a href="utama3.php">Next</a></button>
			<div class="col-1"></div>
		</div>
		<div class="row">
			<div class="bottom">
